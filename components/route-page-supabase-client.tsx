...
export default function RoutePageSupabaseClient({
  ...
  const fromCity = routeData.from_city || "Місто виїзду";
  const toCity = routeData.to_city || "Місто прибуття";
  ...
  const routeSubtitle = /приватний\s+vip\s+трансфер/i.test(routeDescription)
    ? routeDescription
    : routeDescription
      ? `Приватний VIP трансфер. ${routeDescription}`
      : "Приватний VIP трансфер.";
  ...
  const routeDurationDisplay = routeData.duration || "Уточнюється";
  ...
  const routeFinalSeoSentence = `Замовити трансфер ${routeLabel} можна у будь-який час через сайт або Telegram. Ми підберемо авто, узгодимо маршрут і забезпечимо комфортну поїздку без попутників з індивідуальною подачею під ваш графік.`;
  ...
  const routeFaqItems: RouteFaqItem[] = routeFaqItemsBase.map((item) => {
        ...
        <div className="mx-auto max-w-[1536px] px-4 pt-4 sm:px-6 md:px-8 md:pt-5 lg:px-10 xl:px-12 2xl:px-14">
                ...
                <div className="max-w-[39rem]">
                  ...
                  <div className="mt-7 flex flex-wrap gap-3">
                    <div className="route-stat-card">
                      <span className="route-stat-value">від {routePriceDisplay}</span>
                      <span className="route-stat-label">Фіксована ціна</span>
                    </div>
                    <div className="route-stat-card">
                      <span className="route-stat-value">{routeDurationDisplay}</span>
                      <span className="route-stat-label">Час у дорозі</span>
                    </div>
                  </div>
            ...
            <div className="route-pricing-shell rounded-[28px] px-5 py-7 sm:px-7 md:px-9 lg:px-10 lg:py-9">
              <div className="grid gap-7 lg:grid-cols-[minmax(0,0.4fr)_minmax(0,0.6fr)] lg:items-stretch lg:gap-8 xl:gap-10">
                <div className="flex flex-col lg:min-h-full">
                  <p className="eyebrow-lux">ВАРТІСТЬ ТА ЩО ВПЛИВАЄ НА ЦІНУ</p>
                      ...
                      <article key={card.title} className="route-inline-class-card">
                        ...
                        <div className="route-inline-class-image-zone">
                          <button
                            ...
                            aria-label={`Відкрити зображення авто ${card.title}`}
                          >
                            <Image
                              src={card.image}
                              alt={card.title}
                        ...
                        <div className="route-inline-class-specs">
                          <span className="route-inline-class-chip">
                            ...
                            <span>{card.seats} пас.</span>
                          </span>
                          <span className="route-inline-class-chip">
                            <LuggageMiniIcon className="h-[17px] w-[17px]" />
                            <span>{card.luggage} багаж</span>
                          </span>
                        ...
                        <div className="route-inline-class-price">
                          <span className="route-inline-class-price-prefix">від</span>
          ...
          <section className="relative z-10 mt-12 md:mt-16">
            <div className="max-w-[32rem]">
              <p className="eyebrow-lux">ЯК ПРОХОДИТЬ ПОЇЗДКА</p>
            </div>
            ...
            <div className="route-steps-shell mt-8 rounded-[28px] px-5 py-8 sm:px-7 md:px-9 lg:px-10 lg:py-10">
              <div className="route-steps-grid">
                {tripSteps.map(({ number, title, description }) => (
          ...
          <section className="relative z-10 mt-12 md:mt-16">
            ...
            >
              ...
              <div className="route-info-content relative z-10 max-w-[29rem] lg:max-w-[30rem]">
                <p className="eyebrow-lux">ІНФОРМАЦІЯ ПРО МАРШРУТ</p>
                <p className="mt-4 max-w-[28rem] text-[0.92rem] leading-[1.72] text-[var(--muted)]">
                  Маршрут {routeLabel} підходить для приватних клієнтів,
                  бізнес-поїздок та трансферів в аеропорт Кишинева. За потреби
                  доступний індивідуальний водій {fromCity} {toCity} з подачею
                  авто під ваш графік.
                </p>
                <div className="mt-6 space-y-5">
                  {routeDetails.map(({ title, description, Icon }) => (
                ...
                <p className="mt-6 max-w-[29rem] text-[0.9rem] leading-[1.72] text-[var(--muted)]">
                  Маршрут {routeLabel} проходить через прикордонні пункти з
                  урахуванням трафіку та часу проходження кордону. Водій
                  підбирає оптимальний шлях для швидкої та комфортної поїздки.
                </p>
                <p className="mt-4 text-[0.84rem] leading-[1.7] text-[rgba(183,178,168,0.84)]">
                  ...
                  {" "}та{" "}
                  <Link
                    href="/odesa-bucharest"
                    className="text-[var(--soft-gold)] transition hover:text-[var(--champagne)]"
                  >
                    трансфер Одеса — Бухарест
                  </Link>
                  .
                </p>
              </div>
          ...
          <section className="relative z-10 mt-12 md:mt-16">
            <div className="route-airport-shell route-airport-panel relative min-h-[300px] overflow-hidden rounded-[28px] px-5 py-8 sm:px-7 md:px-9 lg:px-11 lg:py-10">
              <Image
                src={airportImage}
                alt="Трансфер в аеропорт Кишинева"
                fill
              ...
              <div className="relative z-10 max-w-[28.75rem]">
                <p className="eyebrow-lux">ТРАНСФЕР В АЕРОПОРТ КИШИНЕВА</p>
          ...
          <section className="relative z-10 mt-12 md:mt-16">
            ...
            <div className="max-w-[32rem]">
              <p className="eyebrow-lux">ПОШИРЕНІ ПИТАННЯ</p>
            </div>
          ...
          >
            <div className="booking-shell rounded-[32px] px-5 py-6 sm:px-7 md:px-9 md:py-9 lg:grid lg:grid-cols-[0.4fr_0.6fr] lg:gap-10 lg:px-12 lg:py-12">
              <div className="max-w-[24rem]">
                <p className="eyebrow-lux">ЗАБРОНЮВАТИ ТРАНСФЕР</p>
          ...
          <section className="relative z-10 mt-12 md:mt-16">
            <div className="panel-soft rounded-[28px] px-5 py-6 sm:px-7 md:px-9 md:py-8 lg:px-12">
              <p className="eyebrow-lux">{`ІНФОРМАЦІЯ ПРО ТРАНСФЕР ${routeLabel.toUpperCase()}`}</p>
...
function getSourceCityLabel(city: string) {
